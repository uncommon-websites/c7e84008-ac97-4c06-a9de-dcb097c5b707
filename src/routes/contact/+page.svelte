...
<main class="w-full overflow-hidden">
      ...
      <div class="space-y-8">
        ...
        <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-100">
          ...
          <p class="text-sm text-gray-700 leading-relaxed mb-4">
            Our consultancy team includes AI engineers, business strategists, and implementation specialists with experience at leading tech companies.
          </p>
          <div class="grid grid-cols-3 gap-4 text-center">
            <div>
              <div class="text-2xl font-bold text-gray-900">50+</div>
              <div class="text-xs text-gray-600">Projects delivered</div>
            </div>
            <div>
  ...
  <section class="max-w-[1400px] mx-auto px-6 py-24">
    <div class="text-center max-w-2xl mx-auto mb-12">
      <h2 class="text-3xl font-medium mb-4">Our offices</h2>
      <p class="text-gray-600">
        We have teams across the United States to serve you better.
      </p>
    </div>
      ...
      {#each offices as office}
        <div class="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-all">
          <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center mb-4">
            <MapPin size={20} class="text-gray-700" />
          </div>
          <h3 class="text-xl font-semibold mb-2">{office.city}</h3>
          <p class="text-sm text-gray-600 mb-1">{office.address}</p>
          <p class="text-sm text-gray-600 mb-3">{office.region}</p>
          <div class="inline-flex items-center gap-2 px-3 py-1 bg-gray-50 rounded-full text-xs font-medium text-gray-700">
            <Clock size={12} />
            {office.timezone}
          </div>
        </div>
  ...
  <!-- FAQ Section -->
  <section class="max-w-[1000px] mx-auto px-6 py-24 bg-gray-50 rounded-3xl">
    <h2 class="text-3xl font-medium mb-8 text-center">Common questions</h2>
    
    <div class="space-y-6">
      <div class="bg-white rounded-xl p-6 border border-gray-200">
        <h3 class="font-semibold text-gray-900 mb-2">How quickly can we get started?</h3>
        <p class="text-sm text-gray-600 leading-relaxed">
          We can typically schedule an initial consultation within 2-3 business days. For rapid pilot programs, we can begin implementation within 1-2 weeks of project kickoff.
        </p>
      </div>

      <div class="bg-white rounded-xl p-6 border border-gray-200">
        <h3 class="font-semibold text-gray-900 mb-2">What information should I prepare for the consultation?</h3>
        <p class="text-sm text-gray-600 leading-relaxed">
          Come prepared with information about your current workflows, pain points, team size, and business goals. Don't worry if you don't have everything — we'll guide you through the discovery process.
        </p>
      </div>

      <div class="bg-white rounded-xl p-6 border border-gray-200">
        <h3 class="font-semibold text-gray-900 mb-2">Do you offer ongoing support after implementation?</h3>
        <p class="text-sm text-gray-600 leading-relaxed">
          Yes. We provide various support packages including monthly retainers, on-demand consulting, and optimization services to ensure your AI solutions continue delivering value as your business evolves.
        </p>
      </div>

      <div class="bg-white rounded-xl p-6 border border-gray-200">
        <h3 class="font-semibold text-gray-900 mb-2">What makes Flowgrid different from other AI consultancies?</h3>
        <p class="text-sm text-gray-600 leading-relaxed">
          We specialize in mid-market companies and focus on rapid implementation with measurable ROI. Our proven frameworks eliminate implementation fears and deliver results in weeks, not months — without enterprise-level budgets.
        </p>
      </div>
    </div>
  </section>
  ...
  <section class="max-w-[1400px] mx-auto px-6 py-24">
    <div class="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-12 md:p-16 text-center text-white">
      <h2 class="text-4xl md:text-5xl font-medium tracking-tight mb-6">Ready to get started?</h2>
      <p class="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
        Join 50+ companies that have transformed their operations with strategic AI implementation.
      </p>
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
        <a href="#form" class="inline-flex items-center justify-center gap-2 bg-white text-blue-600 text-base font-medium px-8 py-4 rounded-full hover:bg-blue-50 transition-colors">
          Send us a message
          <ArrowRight size={18} />
        </a>
        <a href="tel:+15551234567" class="inline-flex items-center justify-center gap-2 bg-transparent text-white border-2 border-white text-base font-medium px-8 py-4 rounded-full hover:bg-white/10 transition-colors">
          <Phone size={18} />
          Call now
        </a>
      </div>
